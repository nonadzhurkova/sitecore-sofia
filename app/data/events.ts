import { GalleryImage, getEventGalleryImages } from "../utils/gallery";
...
export const events: EventMap = {
  "june-2026": {
    ...
    date: "June 22, 2026",
    location: "Online",
    thumbnail: "/events/june-2026/Claude for Devs.jpg",
    shortDescription:
      'Nona Dzhurkova shared how to unlock Claude\'s full potential beyond just "ask it a question" — covering CLAUDE.md as a team contract with AI, context optimisation, and the workflow shift that makes Claude a true collaborator.',
    description: `Nona Dzhurkova spoke about Claude for Developers: Best Practices — sharing how to unlock Claude's full potential beyond just "ask it a question."

🎤 Claude for Developers: Best Practices — Nona Dzhurkova
• CLAUDE.md as your team's contract with AI — giving Claude the context it needs to write code that actually fits your codebase
• Context optimisation — how to structure prompts and workflows so Claude stays accurate across long sessions
• The biggest shift isn't the tool — it's the workflow. Claude works best when you treat it as a collaborator with clear standards, not a shortcut.`,
    coverImage: "/events/june-2026/Claude for Devs.jpg",
    resources: [
      {
        title: "Event Presentation",
        url: "/events/june-2026/Claude Presentation.pptx",
        icon: "📑",
      },
    ],
  },
  "may-2026": {
    id: "4",
    title:
      "Lunch & Learn: AI Tools for Developers + Sitecore Content Hub Deep Dive",
    date: "May 27, 2026",
    location: "Sofia",
    thumbnail: "/events/may-2026/gallery/PXL_20260527_090346689.jpg",
    shortDescription:
      "A Lunch & Learn featuring two sessions: AI-powered developer tools (Jira aggregator, timecard generator, and Project Estimator) and a deep dive into Sitecore Content Hub development.",
...
• Platform Limitations — real issues hit in production and how they were worked around with Sitecore support`,
  ...
  "april-2026-meetup": {
    ...
    thumbnail: "/mcp.jpg",
    shortDescription:
      "An online event in two parts: a SUGCON recap covering Sitecore AI, post-quantum cryptography, MCP, architecture, and publishing — followed by a dedicated CDP & Personalize session.",
...
Stefan Zhuntovski, Software Engineer at Americaneagle.com, led a deep dive into Sitecore CDP and Sitecore Personalize, exploring how these powerful tools help businesses deliver more meaningful, data-driven customer experiences.`,
  ...
  "september-2025-meetup": {
    ...
    shortDescription:
      "The second edition of Sitecore Sofia User Group, hosted by Americaneagle.com. Sessions covered Sitecore for non-technical audiences and an in-depth look at Sitecore Search — extractor & search flow.",
...
The event wrapped up with a networking session, Q&A, food, drinks, and special merch giveaways — bringing the Sitecore community closer together.`,
  ...
  "june-2025-meetup": {
    ...
    shortDescription:
      "A dual-session meetup that featured SUGCON 2025 highlights and a live coding demo where we built this website with Next.js and Vercel. An evening of insights, practical development, and community building.",
